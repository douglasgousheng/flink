...
/**
 * @author douglas
 * @create 2020-11-20 9:21
 */
public class Window_wordCount {
    public static void main(String[] args) throws Exception {
        ...
        WindowedStream<Tuple2<String, Integer>, Tuple, TimeWindow> windowDStream = keyedStream.timeWindow(Time.seconds(30),Time.seconds(5));
